...
export default class Object extends BaseController {
    ...
    private onObjectMatched(event: Event) {
        ...
        this.bindView("/Mitigations" + sObjectId);
    }
    ...
    private onBindingChange() {
        ...
        const detailObject = view.getBindingContext()!.getObject() as { ID: string; Mitigations: string};
        const id = detailObject.ID;
        const name = detailObject.Mitigations;
